    ...
    <div className={`w-full p-4 rounded-2xl bg-gradient-to-r from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800/50 dark:to-slate-900 border border-slate-200/80 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm ${className}`}>
      ...
      <div className="flex items-center gap-2 flex-none">
        {customLink ? (
          ...
          <a
            href="mailto:support@solerz.com?subject=Wholesale%20Hardware%20Procurement%20Inquiry"
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-700 dark:text-emerald-400 text-xs font-semibold transition-colors"
          >
            Procurement Inquiry
