export const TOP_PANEL_BRANDS = [
  'Jinko Solar', 'LONGi Solar', 'Trina Solar', 'Canadian Solar', 'JA Solar',
  'Tongwei (TW Solar)', 'Astronergy (Chint)', 'Risen Energy', 'Talesun', 'Suntech',
  'Qcells (Hanwha)', 'First Solar', 'Maxeon / SunPower', 'REC Group', 'Meyer Burger',
  'Panasonic', 'LG Solar', 'Hyundai Energy Solutions', 'Solaria', 'Axitec',
  'Boviet Solar', 'VSUN Solar', 'Seraphim', 'Eging PV', 'Yingli Solar',
  'Dah Solar', 'GCL System Integration', 'Hengdian Group DMEGC', 'Other / Generic'
];

export const TOP_INVERTER_BRANDS = [
  'Enphase Energy', 'SolarEdge', 'Fronius', 'Growatt', 'Huawei FusionSolar',
  'Sungrow', 'Tesla Solar Inverter', 'SMA Solar Technology', 'Victron Energy', 'GoodWe',
  'Deye', 'Solis (Ginlong)', 'Sofar Solar', 'Solax Power', 'Hoymiles',
  'APsystems', 'Delta Electronics', 'Microtek', 'Luminous', 'Schneider Electric',
  'ABB / Fimer', 'Ingeteam', 'Kaco New Energy', 'CyberPower', 'Must Energy',
