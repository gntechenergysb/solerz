...
export const db = {
  ...
  // Homepage optimized: returns N latest active listings 
  getLatestListings: async (limit: number = 20, marketplaceLayer: 'verified' | 'community' = 'verified'): Promise<Listing[]> => {
