...
Besides the mandatory filter keys above, you must also extract any other critical technical specifications found in the text (e.g., `model`, `dimensions_mm`, `weight_kg`, `max_wind_load_m_s`, `max_snow_load_kn_m2`, `module_orientation`, `warranty_years`, `tilt_angle_degrees`). Format these keys in snake_case and include them as additional properties in the `specifications` JSON.
...
INSERT INTO public.listings (
  ...
  '[Country]', 
  '', 
  '{"mounting_type": "[Type]", "material": "[Material]", "roof_type": "[RoofType]", "...include_all_other_extracted_snake_case_keys_here...": "[Value]"}',
  FALSE,
  FALSE,
  FALSE
);
