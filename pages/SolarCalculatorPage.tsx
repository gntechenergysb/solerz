            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-medium text-slate-800 dark:text-slate-200"
                >
                  <option value={5.5}>High Sun (5.5 hrs - Southwest US, AU, ME)</option>
                  <option value={4.5}>Moderate (4.5 hrs - Southern EU, SE US, Asia)</option>
                  <option value={3.5}>Standard (3.5 hrs - Central EU, Northern US)</option>
                  <option value={3.0}>Low Sun (3.0 hrs - UK, Scandinavia)</option>
                </select>
              </div>
