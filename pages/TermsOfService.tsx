    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 space-y-4">
        ...
        <section className="space-y-2">
          ...
          <p>
            Solerz is a trusted listing platform connecting solar equipment buyers with verified wholesale and community sellers across B2B, B2C, and C2C trades. Our mission is to create a transparent, safe environment where quality solar products can be discovered and individuals and businesses can grow together.
          </p>
          <p>
