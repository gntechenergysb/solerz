          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-100 dark:border-slate-800">
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400 mb-6 pb-6 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-1.5">
                <MapPin className="h-4 w-4" /> {listing.location_countries?.length ? listing.location_countries.join(', ') : (listing.location_country || 'China')}
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center flex-shrink-0 font-bold text-slate-500 dark:text-slate-300 overflow-hidden">
                {user ? (
                  listing.seller_avatar_url && !sellerAvatarFailed ? (
                    <img
                      src={listing.seller_avatar_url}
                      alt={listing.seller_name || 'Supplier'}
